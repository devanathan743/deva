import wtshirt from "../components/aasets/wtshirt.webp";
import wshirt from "../components/aasets/wshirt.webp";
import wjeans from "../components/aasets/wjeans.webp";
import "../components/womensproduct.css";
    ...
    <>
      ...
      <div className="womensproduct">
        <div className="Tshirt">
          ...
          <br />
          <h3 style={{ color: "black", paddingLeft: "20px" }}>₹250 onwards</h3>
          <br />
          <button
            style={{
              color: "white",
        ...
        <div className="wjeans">
          ...
          <br />
          <h3 style={{ color: "black", paddingLeft: "20px" }}>₹329 onwards</h3>
          <br />
          <button
            style={{
              color: "white",
        ...
        <div className="wshirt">
          ...
          <br />
          <h3 style={{ color: "black", paddingLeft: "20px" }}>₹400 onwards</h3>
          <br />
          <button
            style={{
              color: "white",
