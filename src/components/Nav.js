    ...
    <>
      <div>
        ...
        <div className="nav-right" style={{ display: "flex" }}>
          <div className="nav-right1" style={{ display: "flex" }}>
            <TfiMobile style={{ height: "20px", width: "50px" }} />
            <span
              font-size="16px"
              font-weight="demi"
              class="sc-eDvSVe dURizl hover hover"
              color="pinkBase"
            >
              Download App
            </span>
          ...
          <p></p>
          <div className="nav-right1" style={{ marginLeft: "70px" }}>
            Become a Supplier
          </div>
          <div className="nav-right1" style={{ marginLeft: "100px" }}>
            <BsPerson style={{ height: "30px", width: "90px" }} />
            Profile
          </div>
          <div className="nav-right1">
            <BsCart2
              style={{ height: "30px", width: "90px", marginLeft: "80px" }}
            />
          </div>
        </div>
      </div>
